...
export default class Level2 extends Component {
  ...
  _handleSimulator() {
    board.emit("s_and", this.state.val_a, this.state.val_b);
    board.emit("display_msg", "Realizando Teste", "Porta AND (E).  ");
  ...
  _handleFinish(){
    ...
    this.props.history.push("/level3/"+ score)
      ...
      <div className={styles.conteext}>
        <nav className="pt-navbar .modifier">
          <div className="pt-navbar-group pt-align-left">
            ...
            />
            <div className={styles.toptext}>2/3</div>
